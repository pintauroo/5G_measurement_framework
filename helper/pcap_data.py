class PcapData:
    def __init__(self, rtt, inflight, throughput, fairness, avg_rtt, sending_rate, bbr_values=None,
                 bbr_total_values=None, cwnd_values=None, retransmissions=None, retransmissions_interval=None, buffer_backlog=None,
                 data_info=None, wireless_data=None):
        self.rtt = rtt
        ...
        self.wireless_data = wireless_data
    ...
    def from_dict(pcap_dict):
        return PcapData(
            ...
            wireless_data = pcap_dict['wireless_data']
