...
conf_names_of_interest_tag = 'DL_24';
...
figure
gplotmatrix(data{:,:},[],group_label,[],[],12,[],[],xnames)
...
figure
gscatter(data{:,idx1},data{:,idx2},group_label,[],[],2,[],xnames(idx1),xnames(idx2))
legend(conf_names_of_interest)
grid on
...
scatterhist(data{:,idx1},data{:,idx2},'Group',group_label,'Kernel','on','Location','SouthEast',...
    'Direction','out',...
    'LineWidth',[2,2,2,2,2],'Marker','+od.s','MarkerSize',[8,8,8,8,8]);
...
% 
% % Save only the main plot
% saveas(main_axes, 'scatterplot.png');